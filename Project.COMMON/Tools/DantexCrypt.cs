...
namespace Project.COMMON.Tools
{
    ...
    {
        //Şifreleme sınıfı text olarak girilen şifre metnini aşağıdaki akışa göre karıştırır. 
        ...
        public static string DeCrypt(string a)
        {
            ...
            //split gibi iş yapar ancak *_? karakterlerini de alır.
            ...
            foreach (string item in parts)
            {
                if (item.Contains("*"))
                {
                    ...
                    string character = Convert.ToInt32(asciiCode).ToString();
